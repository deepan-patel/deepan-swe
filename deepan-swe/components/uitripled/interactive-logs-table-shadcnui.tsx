...
const SAMPLE_LOGS: Log[] = [
  {
    id: "2",
    timestamp: "2025-01-12T18:21:03Z",
    level: "error",
    service: "order-food-api",
    message: "Request failed: pork detected in payload",
    duration: "12ms",
    status: "400",
    tags: ["food", "validation-failed"],
  },
  {
    id: "3",
    timestamp: "2025-01-12T18:22:10Z",
    level: "info",
    service: "order-food-api",
    message: "Request processed: chicken approved 🍗",
    duration: "98ms",
    status: "200",
    tags: ["food", "favorite"],
  },
  {
    id: "4",
    timestamp: "2025-01-12T18:23:55Z",
    level: "warning",
    service: "order-food-api",
    message: "High frequency of chicken requests detected",
    duration: "3ms",
    status: "429",
    tags: ["food", "rate-limit"],
  },
  {
    id: "5",
    timestamp: "2025-02-01T07:15:22Z",
    level: "info",
    service: "fitness-engine",
    message: "Morning run completed successfully",
    duration: "28m 14s",
    status: "200",
    tags: ["running", "health"],
  },
  {
    id: "6",
    timestamp: "2025-02-02T16:40:11Z",
    level: "info",
    service: "sports-module",
    message: "Basketball session executed with high energy",
    duration: "1h 05m",
    status: "200",
    tags: ["basketball", "active"],
  },
  {
    id: "7",
    timestamp: "2025-02-03T12:05:44Z",
    level: "info",
    service: "sports-module",
    message: "Tennis match completed successfully",
    duration: "52m",
    status: "200",
    tags: ["tennis", "outdoor"],
  },
  {
    id: "8",
    timestamp: "2025-02-05T18:30:09Z",
    level: "info",
    service: "skill-upgrader",
    message: "Currently leveling up: pickleball",
    duration: "in-progress",
    status: "102",
    tags: ["pickleball", "learning"],
  }
];
          ...
          {levels.map((level) => {
            ...
            return (
              <motion.button
                ...
                className={`flex w-full items-center justify-between gap-2 border rounded-md px-3 py-2 text-sm transition-colors ${selected
